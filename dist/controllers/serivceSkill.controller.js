...
exports.ServiceSkillController = void 0;
const utils_1 = require("@core/utils");
const constants_1 = __importDefault(require("@core/config/constants"));
const serviceSkill_service_1 = require("services/serviceSkill.service");
class ServiceSkillController {
    constructor() {
        this.serviceSkillController = new serviceSkill_service_1.SerivceSkillService();
        this.create = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const model = req.body;
            model.user_id = req.id;
            try {
                const result = yield this.serviceSkillController.create(model);
        ...
        this.update = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.serviceSkillController.update(model, id);
                if (result instanceof Error && result.field)
                    return (0, utils_1.sendResponse)(res, result.status, result.message, null, result.field);
                if (result instanceof Error)
                    return (0, utils_1.sendResponse)(res, result.status, result.message);
        ...
        this.delete = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const id = req.params.id;
            try {
                const result = yield this.serviceSkillController.delete(id);
                if (result instanceof Error)
                    return (0, utils_1.sendResponse)(res, result.status, result.message);
        ...
        this.findById = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const id = req.params.id;
            try {
                const result = yield this.serviceSkillController.findById(id);
                if (result instanceof Error)
                    return (0, utils_1.sendResponse)(res, result.status, result.message);
        ...
        this.searchs = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.serviceSkillController.searchs(key, pageInt, limitInt, model);
                if (result instanceof Error)
                    return (0, utils_1.sendResponse)(res, result.status, result.message);
        ...
        this.updatestatus = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const id = req.params.id;
            try {
                const result = yield this.serviceSkillController.updateStatus(id);
                if (result instanceof Error)
                    return (0, utils_1.sendResponse)(res, result.status, result.message);
        ...
        this.deleteList = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.serviceSkillController.deleteList(listId);
                if (result instanceof Error)
                    return (0, utils_1.sendResponse)(res, result.status, result.message);
                return (0, utils_1.sendResponse)(res, 200, constants_1.default.DELETE_SUCCESS, result);
            }
        ...
        this.updateListstatus = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.serviceSkillController.updateListStatus(listId, status);
                if (result instanceof Error)
                    return (0, utils_1.sendResponse)(res, result.status, result.message);
                return (0, utils_1.sendResponse)(res, 200, constants_1.default.UPDATE_SUCCESS, result);
            }
...
exports.ServiceSkillController = ServiceSkillController;
//# sourceMappingURL=serivceSkill.controller.js.map