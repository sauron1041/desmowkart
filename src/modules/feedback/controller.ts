...
export class FeedbackController {
    private userService: FeedbackService;
    constructor() {
        this.userService = new FeedbackService();
    }
    public create = async (req: Request, res: Response) => {
        const model: Feedback = req.body as any as Feedback;
        try {
    ...
    public findAll = async (req: Request, res: Response) => {
        try {
            const model: Feedback = req.query as any as Feedback;
