...
import ServiceRequestImageDto from 'modules/serviceRequestImage/dtos/create';


// trang thai
@Table
class ServiceRequestStatusHistoryDto extends Model {
    ...
    serviceRequestImages?: ServiceRequestImageDto[];

}

export default ServiceRequestStatusHistoryDto;