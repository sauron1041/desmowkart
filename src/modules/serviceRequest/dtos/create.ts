...
import ServiceRequestStatusHistoryDto from 'modules/serviceRequestHistory/dtos/create';

@Table
class ServiceRequestDto extends Model {
  ...
  @HasMany(() => ServiceRequestStatusHistoryDto)
